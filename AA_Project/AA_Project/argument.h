...
public:
	argument() { ID = 1; nature = ECONOMIC; is_pro = true; strength = 0.0; validity = 0.0; }
	argument(int Id, int NAT, bool PRO = true, float STR = 0.0, float VAL = 0.0) {
		ID = Id; nature = NAT;  is_pro = PRO; strength = STR; validity = VAL; }
	~argument() {}
	...
	void set_argument(int Id, int NAT, bool PRO = true, float STR = 0.0, float VAL = 0.0) {
		ID = Id; nature = NAT;  is_pro = PRO; strength = STR; validity = VAL;
	}
};
